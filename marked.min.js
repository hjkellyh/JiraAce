...
!(function (e, t) {
  ...
  class se {
    ...
    code(e) {
      ...
      if (t) {
        ...
        return { type: 'code', raw: t[0], codeBlockStyle: 'indented', text: this.options.pedantic ? e : te(e, '\n') }
      }
    }
    fences(e) {
        ...
        for (; e; ) {
          ...
          if (
            (this.options.pedantic
              ...
              : h
              ? (p = t[1].length + 1)
              : ((p = t[2].search(this.rules.other.nonSpaceChar)), (p = p > 4 ? 1 : p), (o = a.slice(p)), (p += t[1].length)),
          ...
          this.options.gfm &&
            ...
            r.items.push({ type: 'list_item', raw: s, task: !!g, checked: u, loose: !1, text: o, tokens: [] }),
            (r.raw += s)
        }
    ...
    table(e) {
      ...
      if (n.length === s.length) {
        ...
        for (const e of r)
          i.rows.push(ee(e, i.header.length).map((e, t) => ({ text: e, tokens: this.lexer.inline(e), header: !1, align: i.align[t] })))
        return i
      }
    }
    lheading(e) {
      ...
      if (t) {
        ...
        return (
          ...
          this.rules.other.startAngleBracket.test(n) &&
            (n = this.options.pedantic && !this.rules.other.endAngleBracket.test(e) ? n.slice(1) : n.slice(1, -1)),
          ne(
            t,
            {
  ...
  class re {
    ...
    constructor(t) {
      ...
      this.options.pedantic
        ...
        : this.options.gfm && ((n.block = U.gfm), this.options.breaks ? (n.inline = J.breaks) : (n.inline = J.gfm)),
      ...
      for (this.options.pedantic && (e = e.replace(i.tabCharGlobal, '    ').replace(i.spaceLine, '')); e; ) {
        ...
        if (
          this.options.extensions?.block?.some(
            n => !!(s = n.call({ lexer: this }, e, t)) && ((e = e.substring(s.raw.length)), t.push(s), !0)
          )
        )
          continue
        ...
        if ((s = this.tokenizer.code(e))) {
          ...
          'paragraph' === n?.type || 'text' === n?.type
            ? ((n.raw += '\n' + s.raw), (n.text += '\n' + s.text), (this.inlineQueue.at(-1).src = n.text))
            : t.push(s)
          continue
        }
        ...
        if ((s = this.tokenizer.def(e))) {
          ...
          const n = t.at(-1)
          'paragraph' === n?.type || 'text' === n?.type
            ? ((n.raw += '\n' + s.raw), (n.text += '\n' + s.raw), (this.inlineQueue.at(-1).src = n.text))
        ...
        if (this.state.top && (s = this.tokenizer.paragraph(r))) {
          const i = t.at(-1)
          n && 'paragraph' === i?.type
            ? ((i.raw += '\n' + s.raw), (i.text += '\n' + s.text), this.inlineQueue.pop(), (this.inlineQueue.at(-1).src = i.text))
            : t.push(s),
            (n = r.length !== e.length),
            (e = e.substring(s.raw.length))
          ...
          const n = t.at(-1)
          'text' === n?.type
            ? ((n.raw += '\n' + s.raw), (n.text += '\n' + s.text), this.inlineQueue.pop(), (this.inlineQueue.at(-1).src = n.text))
            : t.push(s)
        } else if (e) {
  ...
  class ie {
    ...
    code({ text: e, lang: t, escaped: n }) {
      ...
      return s
        ? '<pre><code class="language-' + W(s) + '">' + (n ? r : W(r, !0)) + '</code></pre>\n'
          ...
          ? 'paragraph' === e.tokens[0]?.type
            ? ((e.tokens[0].text = n + ' ' + e.tokens[0].text),
              e.tokens[0].tokens &&
                ...
                ((e.tokens[0].tokens[0].text = n + ' ' + W(e.tokens[0].tokens[0].text)), (e.tokens[0].tokens[0].escaped = !0)))
    ...
    parse(e, t = !0) {
      ...
      for (let s = 0; s < e.length; s++) {
        ...
        if (this.options.extensions?.renderers?.[r.type]) {
          ...
          if (
            !1 !== t ||
            !['space', 'hr', 'heading', 'code', 'table', 'blockquote', 'list', 'html', 'paragraph', 'text'].includes(e.type)
          ) {
            n += t || ''
            continue
          }
        ...
        switch (i.type) {
          ...
          case 'text': {
            ...
            n += t
              ? this.renderer.paragraph({ type: 'paragraph', raw: l, text: l, tokens: [{ type: 'text', raw: l, text: l, escaped: !0 }] })
              : l
            continue
          }
          default: {
